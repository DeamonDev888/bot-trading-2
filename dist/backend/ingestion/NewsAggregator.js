import { TradingEconomicsScraper } from './TradingEconomicsScraper.js';
import { ZeroHedgeNewsScraper } from './scrapers/ZeroHedgeNewsScraper.js';
import { CNBCNewsScraper } from './scrapers/CNBCNewsScraper.js';
import { FinancialJuiceNewsScraper } from './scrapers/FinancialJuiceNewsScraper.js';
import { FredNewsScraper } from './scrapers/FredNewsScraper.js';
import { FinnhubNewsScraper } from './scrapers/FinnhubNewsScraper.js';
import { CboeNewsScraper } from './scrapers/CboeNewsScraper.js';
import { BlsNewsScraper } from './scrapers/BlsNewsScraper.js';
import { Pool } from 'pg';
...
export class NewsAggregator {
     ...
     */
    async getLastNewsTimestamp(sourceName) {
        const client = await this.pool.connect();
        try {
            const res = await client.query('SELECT MAX(published_at) as last_date FROM news_items WHERE source = $1', [sourceName]);
