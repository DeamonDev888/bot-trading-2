...
exports.AttachmentBuilder = exports.DiscordFileFactory = exports.DiscordFileUploader = void 0;
const discord_js_1 = require("discord.js");
Object.defineProperty(exports, "AttachmentBuilder", { enumerable: true, get: function () { return discord_js_1.AttachmentBuilder; } });
...
class DiscordFileUploader {
     ...
     */
    static createAttachment(options) {
        const attachment = new discord_js_1.AttachmentBuilder(typeof options.content === 'string' ? Buffer.from(options.content, 'utf-8') : options.content, {
            name: options.name,
     ...
     */
    static createCSVFile(data, filename = 'data.csv') {
        if (data.length === 0) {
     ...
     */
    static createJSONFile(data, filename = 'data.json') {
     ...
     */
    static createTextFile(content, filename = 'report.txt') {
        return {
            name: filename,
            content: content,
            type: 'txt',
     ...
     */
    static createMarkdownFile(content, filename = 'document.md') {
        return {
            name: filename,
            content: content,
            type: 'md',
     ...
     */
    static createTypeScriptFile(content, filename = 'script.ts') {
        return {
            name: filename,
            content: content,
            type: 'ts',
     ...
     */
    static createFinancialReportMarkdown(marketData, filename = 'financial_report.md') {
     ...
     */
    static createTypeScriptTypes(data, interfaceName = 'DataTypes', filename = 'types.ts') {
        ...
        const generateType = (obj, indent = 1) => {
            let result = '';
     ...
     */
    static createFinancialReportCSV(marketData, filename = 'financial_report.csv') {
     ...
     */
    static createPortfolioReportCSV(portfolioData, filename = 'portfolio_report.csv') {
     ...
     */
    static createTechnicalAnalysisJSON(analysis, filename = 'technical_analysis.json') {
        return this.createJSONFile(analysis, filename);
    }
    /**
     * Sauvegarder un fichier localement (temporaire)
     */
    static async saveTempFile(options) {
...
exports.DiscordFileUploader = DiscordFileUploader;
DiscordFileUploader.MIME_TYPES = {
    'csv': 'text/csv',
...
class DiscordFileFactory {
    /**
     * Créer un rapport de marché complet
     */
    static async createMarketReport(marketData) {
        const file = DiscordFileUploader.createFinancialReportCSV(marketData, `market_report_${new Date().toISOString().split('T')[0]}.csv`);
        return {
            type: 'file_upload',
            fichier: file,
            message: {
     ...
     */
    static async createPortfolioReport(portfolioData) {
        ...
        const file = DiscordFileUploader.createPortfolioReportCSV(portfolioData, `portfolio_report_${new Date().toISOString().split('T')[0]}.csv`);
        return {
            type: 'file_upload',
            fichier: file,
            message: {
     ...
     */
    static async createTechnicalAnalysisReport(analysis) {
        const file = DiscordFileUploader.createTechnicalAnalysisJSON(analysis, `technical_analysis_${analysis.symbol}_${new Date().toISOString().split('T')[0]}.json`);
        return {
            type: 'file_upload',
            fichier: file,
            message: {
...
exports.DiscordFileFactory = DiscordFileFactory;
