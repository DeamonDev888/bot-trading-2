---
name: agent_TOON
description: Agent spécialisé dans le format Toon (Token-Oriented Object Notation). Expert en conversion JSON/YAML/CSV vers Toon pour optimiser les tokens dans les prompts LLM.
