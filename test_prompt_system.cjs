...
class PromptSystemTester {
    ...
    needsStructuredResponse(message: string, intent: string): boolean {
    ...
    extractAssetFromMessage(message: string): string {
    ...
    extractFilenameFromMessage(message: string): string {
    ...
    private addResult(test: string, success: boolean, result?: any, error?: string): void {
        this.results.push({ test, success, result, error });
    }

    // Tests de détection de réponse structurée
    async testStructuredResponseDetection(): Promise<void> {
    ...
    async testAssetExtraction(): Promise<void> {
    ...
    async testFilenameExtraction(): Promise<void> {
    ...
    async testJSONFormatValidation(): Promise<void> {
    ...
    async testPromptCompatibility(): Promise<void> {
